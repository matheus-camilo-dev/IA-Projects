...
# Select data model: Fashion MNIST
fashion_mnist = tf.keras.datasets.fashion_mnist

# Get Train and Test Images and Labels
(train_images, train_labels), (test_images, test_labels) = fashion_mnist.load_data()

# Catetories for labels
class_names = ['T-shirt/top', 'Trouser', 'Pullover', 'Dress', 'Coat',
               'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankle boot']

# Transform images to grey scale
train_images = train_images / 255.0
test_images = test_images / 255.0

# Configure neural net layers
...
# Train model using train images and labesl
model.fit(train_images, train_labels, epochs=10)

# Evaluate model using test images and labels
